          ...
          {({ values, touched, errors, isSubmitting, setFieldValue }) => (
            <Form>
              <DialogContent dividers>
                ...
                <div>
                <Grid container alignItems="center" spacing={2}  style={{ width: '100%' }}>
                ...
                <Grid item>
                  ...
                  onClick={() => {
                    const chave = handleGerarChaveAlfanumerica(20);
                    setFieldValue("token", chave);
                  }}
                  >
                  {i18n.t('whatsappModal.form.geratoken')}
                  </Button>
                </Grid>
              </Grid>
                </div>
...
function handleGerarChaveAlfanumerica(tamanho) {

  ...
  tr: {
    translations: {
      ...
      qrCode: {
        ...
        firstline: "Telefonunuzda WhatsApp'ı açın",
            secondline: {
              touch: "Android'de Diğer seçenekler'e dokunun",
             orsetting: "veya Ayarlar",
             iphone: "iPhone'da",
             },
            thirdline: "Bağlı Cihazlar'a dokunun, ardından Cihazları Bağla'ya dokunun",
            fourthline: "QR Kodunu yakalamak için telefonunuzu bu ekrana doğrultun",
            content:
              "'QR Kodu' butonuna tıklayın ve telefonunuzdan QR Kodu okutarak oturumu başlatın."
      },
      fastResponses: {
